...
Po přihlášení se z backendu získá JWT token a uloží se do localStorage. React Context (AuthContext) pak načte aktuálního uživatele (/api/v1/auth/me) a uloží ho do user.
